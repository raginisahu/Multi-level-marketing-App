      ...
      <View style={styles.picture}>
         ...
         {/* <View style={styles.header}>
         ...
         </View> */}
          {
            ...
            <Text> </Text>
            <Text> </Text>
            <Text style={styles.noNotes}> You have not received the notifications</Text>  
            <Text> </Text>
            <Text> </Text>      
           <Text> </Text>
             <Text> </Text>
            ...
            <FlatList
              ...
              <LinearGradient colors={['#e1bee7','#ffebee','#ffffff']} style={styles.linearGradient}>
                <View style={styles.offerListView}>
                  ...
                  <Text numberOfLines={1} ellipsizeMode={'tail'} style={styles.offerListTitle}>{item.message}</Text>
